  ...
  return (
    <div className="w-64 h-full bg-white/90 backdrop-blur-md rounded-none lg:rounded-2xl border border-gray-200 shadow-lg p-3 sm:p-4 flex flex-col gap-3 sm:gap-4 overflow-y-auto lg:overflow-y-hidden">
      ...
      <Link
        ...
        onClick={handleLinkClick}
        className="group relative flex items-center gap-3 sm:gap-4 overflow-hidden bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl border border-orange-100 shadow hover:shadow-lg transition-all duration-300 p-3 sm:p-4"
      >
        <div className="p-2.5 sm:p-3 rounded-lg bg-gradient-to-br from-orange-600 to-orange-500 text-white shadow-md">
          <BarChart3 className="w-4 h-4 sm:w-5 sm:h-5" />
        </div>
        <div>
          <div className="text-slate-800 font-semibold text-sm sm:text-base">Analytics</div>
          <div className="text-slate-600 text-xs">Insights & reports</div>
        </div>
      </Link>
